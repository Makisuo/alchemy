import { type OIDCProviderProps } from "./oidc-provider.ts";
/**
 ...
 */
export interface GitHubOIDCProviderProps extends Omit<OIDCProviderProps, "thumbprint"> {
    /**
 ...
 * });
 */
export declare const GitHubOIDCProvider: (id: string, props: GitHubOIDCProviderProps) => Promise<{
    providerArn: string;
    createdAt: number;
    owner: string;
    repository: string;
...
//# sourceMappingURL=github-oidc-provider.d.ts.map